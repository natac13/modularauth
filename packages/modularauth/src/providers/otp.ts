...
import type { StorageAdapter, Provider, ProviderHandlers, AuthorizationState } from '../core/types.js'
...
export interface OTPConfig {
   ...
   * ```
   */
  sendCode: (claims: Record<string, string>, code: string) => Promise<void | { type: "invalid_claim"; key: string; value: string }>
 ...
 * ```
 */
export class OTPProvider implements Provider<OTPConfig, { claims: Record<string, string> }> {
  type = "otp" as const
