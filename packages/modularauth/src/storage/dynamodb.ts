/**
 * Configure ModularAuth to use [DynamoDB](https://aws.amazon.com/dynamodb/) as a storage adapter.
 *
 * ```ts
 * import { DynamoStorage } from "@modularauth/core/storage/dynamodb"
 *
